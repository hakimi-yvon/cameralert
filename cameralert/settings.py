...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-a5d^hx^&oq_)t-4af9k4%-&=ym478++89xuu+*oi1^#57w3$z+'
)
...
# Database
# Uses DATABASE_URL if available (PostgreSQL in production), falls back to SQLite for local development
...
# Cloudinary Configuration (active if CLOUDINARY_CLOUD_NAME is defined)
CLOUDINARY_STORAGE = {
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'CamerAlert <noreply@cameralert.cm>')
